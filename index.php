    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                <a class="navbar-brand" id="logo"> <h2>EST<img src="img/logo.png">QUE</h2></a>
        ...
        <main role="main">
            ...
            <div class="row featurette">
                <div class="col-md-6 featuresText">
                ...
                <div class="col-md-5">
                    <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 500px;" src="img/facil.jpeg" data-holder-rendered="true">
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="img/planos.jpg" data-holder-rendered="true" style="width: 500px; height: 500px;">
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="img/contato.png" data-holder-rendered="true" style="width: 500px; height: 500px;">
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 featuresText order-md-1">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="img/empresa.png" data-holder-rendered="true" style="width: 500px; height: 500px;">
                </div>
            </div>
